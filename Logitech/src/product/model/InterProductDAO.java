...
public interface InterProductDAO {
	...
	// 찜하기 페이지에서 상품 목록을 select 해오는 함수
		...
		ArrayList<ProductVO> selectCartProduct(String usernum) throws SQLException;
		...
		// 주문내역 관련 리스트를 select 해오는 메소드
		ArrayList<HashMap<String, String>> selectOrderList(String usernum) throws SQLException;

		// 주문날짜가 오늘인 주문내역을 select 해오는 메소드
		ArrayList<HashMap<String, String>> todaySelectOrderList(String usernum)throws SQLException;

		// 주문날짜가 1주일 이내인 주문내역을 select 해오는 메소드
		ArrayList<HashMap<String, String>> weekSelectOrderList(String usernum) throws SQLException;

		// 주문날짜가 1개월 이내인 주문내역을 select 해오는 메소드
		ArrayList<HashMap<String, String>> month1SelectOrderList(String usernum, String month) throws SQLException;

		// 6개월 동안의 주문 총갯수 얻어오기
		int sumOrderSelect(String usernum) throws SQLException;

		ArrayList<HashMap<String, String>> viewReviewSelect(String memberno) throws SQLException;

		int insertReview(ReviewVO rv);

		ArrayList<HashMap<String, String>> selectMyReview(Map<String, String> paraMap) throws SQLException;

		int getTotalReviewPage(String memberno) throws SQLException ;

		int deleteReview(String seqredel) throws SQLException;

		ArrayList<Map<String, String>> selectCouponList(String memberno, String grade);

		String selectGrade(String memberno) throws SQLException;

		int insertEachCoupon(String fk_couponcode, String memberno) throws SQLException;

		ArrayList<Map<String, String>> selectEachCoupon(Map<String, String> map) throws SQLException;

		String selectEachproId(String productid, String color) throws SQLException;

		///////////////정섭오빠꺼 ////////////////
		List<ProductVO> productPurchase(Map<String, String> paraMap) throws SQLException;

		List<EachCouponVO> selectCoupon(Map<String, String> paraMap2) throws SQLException;
		////////////////////////////////////////

		ProductVO mapPvo(String string) throws SQLException;

		ProductVO productPurchase2(Map<String, String> map) throws SQLException;

		int deleteOrderCart(Map<String, String> map, String memberno) throws SQLException;

		int selectCntCoupon(int usernum) throws SQLException;

		int selectSumPrice(int usernum) throws SQLException;

		Map<String, String> selectMinMaxGrade(String grade) throws SQLException;

		String selectNextGrade(String min) throws SQLException;

		int selectMediumNum(int usernum) throws SQLException;

		int selectEndNum(int usernum) throws SQLException;

		int getTotalCouponPage(String memberno) throws SQLException;

		MemberVO editMember(String memberno) throws SQLException;

		int updateMember(MemberVO mvo) throws SQLException;

		int updateReview(ReviewVO revo) throws SQLException;

		int selectNumReview(String memberno) throws SQLException;

		int selectWriteReview(String memberno) throws SQLException;
