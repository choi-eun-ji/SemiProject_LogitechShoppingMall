...
<title>Welcome to Logitech</title>
	...
	<div class="totalWrap" id="menuWrap">
		<div id="wrap">
			<header id="page_header">
				...
				<ul id="menu">
					<li><a href="mouse.sg">마우스</a></li>
					<li><a href="keyboard.sg">키보드</a></li>
					<li><a href="headset.sg">헤드셋</a></li>
					<li><a href="speaker.sg">스피커</a></li>
					<li><a href="service.sg">고객센터</a></li>
				</ul>
