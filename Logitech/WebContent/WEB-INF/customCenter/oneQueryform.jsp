...
<script>
	...
	$(document).ready(function() { 
		...
		var textareaVal = $("textarea[name=content]").val();
		var anformVal = $("input[name=anform]:checked").val();
		
		

		
		
			if(selectVal == "" ||  titleVal == "" || textareaVal == "") {
			...
			<table id="tblOneQueryRegister">
				...
				<tbody>
					...
					<tr>
						...
						<select	id="category" name="category" style="margin-left: 2%; width: 120px; padding: 8px;" >
					...
					<tr>
						...
						<td style="width: 80%; text-align: left;"><input type="text"
							name="title" style="width: 98%; margin-left: 2%;" required /></td>
					</tr>

					<tr>
						<td style="width: 20%; font-weight: bold;">내용</td>
						<td style="width: 80%; text-align: left;"><textarea
								name="content" cols="30" rows="10" style="width: 98%; margin-top: 8px" required></textarea></td>
					</tr>

					<tr>
						<td style="width: 20%; font-weight: bold;">답변 희망 형태</td>
						<td style="width: 80%; text-align: left;"><input id="check1"
							name="anform" type="checkbox" style="margin-left: 2%;" value="1" required>
