				...
				<c:if test="${not empty povo}">
					...
					<div id="povoInfo" style="background-color: white;">
						<table id="tblProduct">
							...
							<tr>
								<td class="myli" style="font-weight: bold;">할인 종료일&nbsp;</td>
								<td style="text-align: left;">
									<div class="liInfo"></div>
									<input type="text" name="saleday" id="saleday" value="${povo.saleday}" size="30" disabled="disabled" required />
								</td>
							</tr>
							<tr>
								...
								<td style="width: 70%; text-align: left;">
									<button type="button" style="border: none; width: 200px; height: 50px; background-color: #1a1a1a; color: white; text-align: center;" onclick="goProdUpdate();">제품 수정</button>
							...
							<tr>
								...
								<td style="width: 70%; text-align: left;">
									<button type="button" style="border: none; width: 200px; height: 50px; background-color: #1a1a1a; color: white; text-align: center;" onclick="javascript:goProdOptionList();">제품목록으로 이동</button>
								</td>
							</tr>
						</table>
					</div>
