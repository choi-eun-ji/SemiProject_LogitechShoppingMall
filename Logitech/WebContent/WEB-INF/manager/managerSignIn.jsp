...
<body style="background-image: url('/Logitech/images/signin-1LWiYun3Rm0-unsplash.jpg'); background-size: 100%;">
...
<c:choose>
	<c:when test="${empty sessionScope.loginManager}">
		<form name="frmSignIn">
			<div class="layer">
				<div class="content">
					<img src="/Logitech/images/logo_nobg.png" width="400" height="160">
					...
					<p>&copy; 2020 Sist team one. All rights reserved</p>
				</div>
				<div class="blank"></div>
			</div>
		</form>
